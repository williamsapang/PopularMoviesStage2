...
public class FavoriteDatabaseProvider extends ContentProvider {

    static final String PROVIDER_NAME = "com.example.samsophias.popularmoviesstage2";
    ...
    static final String CREATE_DB_TABLE = "CREATE TABLE " + FAVORITES_TABLE_NAME +
            " (_id INTEGER PRIMARY KEY, " + " title TEXT NOT NULL, " + " poster_path TEXT NOT NULL, " +
